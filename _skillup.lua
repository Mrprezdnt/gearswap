...
user_settings = {
    user_spells = {
        ...
        Geomancy = T{"Indi-Poison","Indi-Precision","Indi-Voidance"},
        Enhancing = T{"Barfire","Barblizzard","Baraero","Barstone","Barthunder","Barwater","Barpoison","Barparalyze","Refresh","Regen","Protect","Shell","Sneak","Invisible","Barsleep"},
        Ninjutsu = T{},
        Singing = T{},
