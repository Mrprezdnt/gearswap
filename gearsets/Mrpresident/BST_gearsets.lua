...
---------------------------------------------------------------------------------------------
	...
	sets.TP = {
    	...
    	body={ name="Taeon Tabard", augments={'Pet: Accuracy+25 Pet: Rng. Acc.+25','Pet: Crit.hit rate +3',}},
    	hands={ name="Acro Gauntlets", augments={'Pet: Accuracy+14 Pet: Rng. Acc.+14','Pet: "Store TP"+6',}},
    	legs={ name="Taeon Tights", augments={'Pet: Attack+15 Pet: Rng.Atk.+15','Pet: "Dbl. Atk."+5',}},
    	feet={ name="Acro Leggings", augments={'Pet: Accuracy+17 Pet: Rng. Acc.+17','Pet: "Dbl. Atk."+3',}},
    	...
    	back={ name="Pastoralist's Mantle", augments={'STR+3 DEX+3','Accuracy+3','Pet: Accuracy+16 Pet: Rng. Acc.+16',}},}
